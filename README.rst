...
Its purpose is to return the information stored in HTML tables on `wiki.ninux.org`_ and in the ninux.org `phpipam instance`_ (feature not yet implemented) as a whois service.
